...
from dataset.cifar10_dataset import get_dataset_CL as get_dataset_cifar10_CL
from dataset.cifar100_dataset import get_dataset_CL as  get_dataset_cifar100_CL
...
# Reshape data loaders
def data_config_CL(args):
    ...
    if args.dataset == 'cifar10':
        trainset = get_dataset_cifar10_CL(args, transform_train)
    elif args.dataset == 'cifar100':
        trainset = get_dataset_cifar100_CL(args, transform_train)
    ...
    print('############# Reshaped trained data loaded #############')
    return train_loader
